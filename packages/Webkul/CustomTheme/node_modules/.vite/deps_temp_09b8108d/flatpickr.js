...
var require_flatpickr = __commonJS({
  "node_modules/flatpickr/dist/flatpickr.js"(exports, module) {
    ...
    function Flatpickr(element, config) {
      ...
      function bind(element2, event, handler) {
        if (event instanceof Array)
          return event.forEach(function(ev) {
            return bind(element2, ev, handler);
          });
        ...
        self._handlers.push({ element: element2, event, handler });
      }
      ...
      function bindEvents() {
        ...
        if (self.config.enableTime) {
          var selText = function selText2(e) {
      ...
      function focusOnDay(currentIndex, offset) {
        var newIndex = currentIndex + offset || 0, targetNode = currentIndex !== void 0 ? self.days.childNodes[newIndex] : self.selectedDateElem || self.todayDateElem || self.days.childNodes[0], focus = function focus2() {
          targetNode = targetNode || self.days.childNodes[newIndex];
          targetNode.focus();
          if (self.config.mode === "range")
            onMouseOver(targetNode);
        };
        if (targetNode === void 0 && offset !== 0) {
          if (offset > 0) {
            self.changeMonth(1);
      ...
      function buildDays(delta) {
        ...
        self.selectedDateElem = void 0;
        self.todayDateElem = void 0;
        ...
        if (!self.config.animate || delta === void 0)
      ...
      function changeMonth(value, is_offset, animate) {
        is_offset = is_offset === void 0 || is_offset;
        ...
        buildDays(!skipAnimations ? delta : void 0);
        if (skipAnimations) {
      ...
      function isEnabled(date, timeless) {
        if (self.config.minDate && compareDates(date, self.config.minDate, timeless !== void 0 ? timeless : !self.minDateHasTime) < 0 || self.config.maxDate && compareDates(date, self.config.maxDate, timeless !== void 0 ? timeless : !self.maxDateHasTime) > 0)
          return false;
        if (!self.config.enable.length && !self.config.disable.length)
          return true;
        var dateToCheck = self.parseDate(date, null, true);
      ...
      function onMouseOver(elem) {
        ...
        var _loop = function _loop2(timestamp2, i2) {
          var outOfRange = timestamp2 < self.minRangeDate.getTime() || timestamp2 > self.maxRangeDate.getTime(), dayElem = self.days.childNodes[i2];
          if (outOfRange) {
            self.days.childNodes[i2].classList.add("notAllowed");
          ...
          if (initialDate < hoverDate && timestamp2 === initialDate.getTime())
            dayElem.classList.add("startRange");
          else if (initialDate > hoverDate && timestamp2 === initialDate.getTime())
            dayElem.classList.add("endRange");
          if (timestamp2 >= minRangeDate && timestamp2 <= maxRangeDate)
      ...
      function parseConfig() {
        ...
        for (var _i = hooks.length; _i--; ) {
          if (self.config[hooks[_i]] !== void 0) {
    ...
    Flatpickr.prototype = {
      ...
      formatDate: function formatDate(dateObj, frmt) {
        var _this = this;
        if (this.config !== void 0 && this.config.formatDate !== void 0)
      ...
      parseDate: function parseDate(date, givenFormat, timeless) {
        ...
        if (date instanceof Date) {
          ...
          if (date === "today") {
            ...
            var parsedDate = !this.config || !this.config.noCalendar ? new Date((/* @__PURE__ */ new Date()).getFullYear(), 0, 1, 0, 0, 0, 0) : new Date((/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0));
            var matched = void 0;
